    ...
    <section className="section-minimal bg-black text-white py-24">
      <div className="container-minimal">
        ...
        >
          {/* Main Title */}
          <motion.h2 
            className="font-light text-white mb-8 tracking-wide"
          ...
          {/* Subtitle */}
          <motion.h3 
            className="text-2xl font-light text-gray-300 mb-12"
          ...
          {/* Main Content */}
          <motion.p 
            className="text-white leading-relaxed font-light mb-12"
