          ...
          >
            <div className="flex flex-col lg:flex-row h-full">
              ...
              <div className="lg:w-1/2 p-8 flex items-center justify-center bg-gradient-to-br from-beige-light to-beige">
                ...
                >
                  <div className="w-auto h-[400px] lg:h-[500px] bg-gradient-to-br from-red-800/20 to-gray-900/20 rounded-2xl flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-gray-600 text-lg">{wine.name}</p>
                    </div>
                  </div>
                </motion.div>
              </div>
  ...
  return (
    <>
      <motion.section 
        ...
        variants={fadeInUp}
      >
        <div className="container-minimal pt-12">
          <motion.div 
              ...
              >
                ...
                >
                  <div className="h-full w-auto flex items-center justify-center">
                    <div className="text-center">
                      <p className="text-gray-600 text-sm">{wine.name}</p>
                    </div>
                  </div>
                </motion.div>
                <motion.h3 
