...
const TrefethenPage = () => {
  ...
  // Setup CTA timer - show CTA 15 seconds before video ends (43s duration)
  useEffect(() => {
    ...
    // Show CTA 15 seconds before the end (at 28 seconds)
    const ctaDelay = (43 - 15) * 1000; // 28 seconds
    
    console.log(`Trefethen video (43s), CTA appears at: ${ctaDelay/1000}s`);
    
    ctaTimerRef.current = setTimeout(() => {
      console.log(`Showing CTA for Trefethen`);
      setShowCTA(true);
    }, ctaDelay);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p style={{ 
                ...
                Experience the legacy and passion of Trefethen Family Vineyards, where five decades of winemaking excellence meet the heart of Napa Valley.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <div style={{position:'relative',overflow:'hidden',paddingBottom:'56.25%'}}>
                  <iframe 
                    src="https://cdn.jwplayer.com/players/FSUUFWTG-O0V5rBgo.html" 
                    width="100%" 
                    height="100%" 
                    frameBorder="0" 
                    scrolling="auto" 
                    title="The-Dirt-Series Trefethen 1080x1920 C03 (1)" 
                  ...
                  {showCTA && (
                    ...
                    >
                      <a
                        href="https://www.trefethen.com/"
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => {
                          e.preventDefault();
                          window.open('https://www.trefethen.com/', '_blank', 'noopener,noreferrer');
                        }}
                        style={{
                          display: 'inline-flex',
                          alignItems: 'center',
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Discover the story behind Trefethen's exceptional wines and their commitment to sustainable farming. 
                  This 43-second journey showcases their dedication to crafting world-class Cabernet Sauvignon and Chardonnay.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h3 style={{ 
                ...
                Connect with Trefethen Family Vineyards
              </h3>
              ...
              <div className="flex justify-center items-center gap-6">
                ...
                {/* Instagram Link */}
                <a 
                  href="https://www.instagram.com/trefethenfamily/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Facebook Link */}
                <a 
                  href="https://www.facebook.com/trefethenfamily" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
