...
const SullivanPage = () => {
  ...
  // Setup CTA timer - show CTA 15 seconds before video ends (38s duration)
  useEffect(() => {
    ...
    // Show CTA 15 seconds before the end (at 23 seconds)
    const ctaDelay = (38 - 15) * 1000; // 23 seconds
    
    console.log(`Sullivan video (38s), CTA appears at: ${ctaDelay/1000}s`);
    
    ctaTimerRef.current = setTimeout(() => {
      console.log(`Showing CTA for Sullivan`);
      setShowCTA(true);
    }, ctaDelay);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p style={{ 
                ...
                Discover the story behind Sullivan Rutherford Estate and their commitment to crafting exceptional wines from the heart of Napa Valley.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <div style={{position:'relative',overflow:'hidden',paddingBottom:'56.25%'}}>
                  <iframe 
                    src="https://cdn.jwplayer.com/players/bE41U3pF-O0V5rBgo.html" 
                    width="100%" 
                    height="100%" 
                    frameBorder="0" 
                    scrolling="auto" 
                    title="The-Dirt-Series Sullivan 1080x1920 C03 (1)" 
                  ...
                  {showCTA && (
                    ...
                    >
                      <a
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          window.open('https://sullivanwine.com/estate-experiences/', '_blank', 'noopener,noreferrer');
                        }}
                        style={{
                          display: 'inline-flex',
                          alignItems: 'center',
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Experience the passion and dedication that goes into every bottle at Sullivan Rutherford Estate. 
                  This 38-second journey takes you behind the scenes of their winemaking process.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h3 style={{ 
                ...
                Connect with Sullivan Rutherford Estate
              </h3>
              
              <div className="flex justify-center items-center gap-6">
                {/* Website Link */}
                <a 
                  href="https://sullivanwine.com/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Instagram Link */}
                <a 
                  href="https://www.instagram.com/sullivan.rutherford.estate" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Facebook Link */}
                <a 
                  href="https://www.facebook.com/SullivanRutherfordEstateWinery" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
