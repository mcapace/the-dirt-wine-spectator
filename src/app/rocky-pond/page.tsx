...
const RockyPondPage = () => {
  ...
  useEffect(() => {
    ...
    const ctaDelay = (durationSec - 15) * 1000;
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p style={{ 
                ...
                Discover how Rocky Pond Estate Winery brings Washington&apos;s Columbia Valley terroir from soil to glass.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <div style={{position:'relative',overflow:'hidden',paddingBottom:'56.25%'}}>
                  <iframe 
                    ...
                    frameBorder="0" 
                    scrolling="auto" 
                    title="The Dirt — Rocky Pond Estate Winery" 
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  From Double D to Rocky Reach, see how sustainable farming and Columbia Valley soils shape every bottle.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h3 style={{ 
                ...
                Connect with Rocky Pond Estate Winery
              </h3>
              ...
              <div className="flex justify-center items-center gap-6">
                ...
                {/* Instagram Link */}
                <a 
                  href="https://www.instagram.com/rockypondwinery/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Facebook Link */}
                <a 
                  href="https://www.facebook.com/rockypondwinery" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
