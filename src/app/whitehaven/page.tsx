...
const WhitehavenPage = () => {
  const [showCTA, setShowCTA] = useState(false);
  const ctaTimerRef = useRef<NodeJS.Timeout | null>(null);

  // Setup CTA timer - show CTA 15 seconds before video ends (49s duration)
  useEffect(() => {
    ...
    // Show CTA 15 seconds before the end (at 34 seconds)
    const ctaDelay = (49 - 15) * 1000; // 34 seconds
    
    console.log(`Whitehaven video (49s), CTA appears at: ${ctaDelay/1000}s`);
    
    ctaTimerRef.current = setTimeout(() => {
      console.log(`Showing CTA for Whitehaven`);
      setShowCTA(true);
    }, ctaDelay);
          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p style={{ 
                ...
                Journey to New Zealand's Marlborough region and discover the exceptional Sauvignon Blancs that put Whitehaven on the world wine map.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <div style={{position:'relative',overflow:'hidden',paddingBottom:'56.25%'}}>
                  <iframe 
                    src="https://cdn.jwplayer.com/players/L6WSfCgB-O0V5rBgo.html" 
                    width="100%" 
                    height="100%" 
                    frameBorder="0" 
                    scrolling="auto" 
                    title="The-Dirt-Series Whitehaven 1080x1920 C03 (1)" 
                  ...
                  {showCTA && (
                    ...
                    >
                      <a
                        href="https://whitehavenwine.com"
                        target="_blank"
                        rel="noopener noreferrer"
                        onClick={(e) => {
                          e.preventDefault();
                          window.open('https://whitehavenwine.com', '_blank', 'noopener,noreferrer');
                        }}
                        style={{
                          display: 'inline-flex',
                          alignItems: 'center',
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-gray-300 mb-6 max-w-2xl mx-auto">
                  Experience the pristine beauty of Marlborough and the passion behind Whitehaven's world-class wines. 
                  This 49-second journey captures the essence of New Zealand's premier wine region.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h3 style={{ 
                ...
                Connect with Whitehaven Wine Company
              </h3>
              
              <div className="flex justify-center items-center gap-6">
                {/* Website Link */}
                <a 
                  href="https://www.whitehavenwine.com/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Facebook Link */}
                <a 
                  href="https://www.facebook.com/whitehavenwine/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
