          ...
          <div className="max-w-7xl mx-auto">
            ...
            >
              ...
              <p style={{ 
                ...
                Paso Robles through the lens of Robert Hall — bold wines rooted in California&apos;s Central Coast.
              </p>
            </motion.div>
          </div>
        </section>
            ...
            >
              ...
              <div className="relative w-full aspect-video rounded-2xl overflow-hidden shadow-2xl">
                <div style={{position:'relative',overflow:'hidden',paddingBottom:'56.25%'}}>
                  <iframe 
                    ...
                    frameBorder="0" 
                    scrolling="auto" 
                    title="The Dirt — Robert Hall Winery" 
              ...
              <div className="mt-8 text-center">
                ...
                <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                  A quick vertical look at terroir, craft, and the people behind Robert Hall&apos;s Paso Robles wines.
                </p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            >
              <h3 style={{ 
                ...
                Connect with Robert Hall Winery
              </h3>
              ...
              <div className="flex justify-center items-center gap-6">
                ...
                {/* Instagram Link */}
                <a 
                  href="https://www.instagram.com/roberthallwines/" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
                ...
                {/* Facebook Link */}
                <a 
                  href="https://www.facebook.com/RobertHallWinery" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  style={{ 
                    display: 'flex',
